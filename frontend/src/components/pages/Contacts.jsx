		...
		<div className="contact-top-grids">
			<div className="col-md-6 contact-left-">
				<div className="left-top">
					...
					<p><i className="fa fa-calendar" aria-hidden="true"></i><strong>Monday - Friday <span className="dot">:</span></strong>9:30 AM to 6:30 PM</p>
					<p><i className="fa fa-map-marker" aria-hidden="true"></i><strong className="p">address <span className="dot1">:</span></strong>Chicago, 5th main road, carnivalle</p>
					<p><i className="fa fa-phone" aria-hidden="true"></i><strong className="p1">phone <span className="dot2">:</span></strong>+040 2345 6789</p>
					<p><i className="fa fa-envelope" aria-hidden="true"></i><strong className="p2">email <span className="dot3">:</span></strong><a href="mailto:info@example.com">example@email.com</a></p>
				</div>
			...
			<div className="contact-w3ls">
				<form action="#" method="post">
					<div className="col-md-7 col-sm-7 contact-left agileits-w3layouts">
						...
						<input type="text" className="email" name="Last Name" placeholder="Last Name" required=""/>
					</div> 
